...
def run_restricted_high_transit_motion(
    ...
    try:
        ...
        # Freeze each vertical command at the latest measured XY: carrying
        # the original side-clear XY through a long lift made an otherwise
        # harmless 10-12 mm lateral controller offset consume almost all of
        # the unchanged 15 mm Cartesian tracking budget.
        required_transit_z = (
